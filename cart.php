...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <a href="Show_Product.php?pid=<?= $fetch_cart['pid']; ?>" class="fas fa-eye"></a>
      ...
      <div class="sub-total">Total : <span><?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?> DH</span> </div>
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($total > 1)?'':'disabled'; ?>" onclick="return confirm('delete all from cart?');">delete all items</a>
