...
<section class="products">
   ...
   <?php
     $category = $_GET['categ_name'];
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE id_categ LIKE '%{$category}%'");
   ...
   <form action="" method="post" class="box">
      ...
      <a href="Show_Product.php?pid=<?= $fetch_product['id_categ'];?>" class="fas fa-eye"></a>
