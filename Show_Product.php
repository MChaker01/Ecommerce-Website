   ...
   <form action="" method="post" class="box">
      ...
      <div class="row">
         ...
         <div class="content">
            ...
            <div class="flex-btn">
               <input type="submit" value="Add To Cart" class="quick-view-btn btn" name="add_to_cart">
               <!-- <input class="quick-view-btn btn" type="submit" name="add_to_wishlist" value="Add to Wishlist"> -->
               <button class="fas fa-heart btn-heart" name="add_to_wishlist"></button>
            </div>
